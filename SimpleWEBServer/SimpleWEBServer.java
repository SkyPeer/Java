...
class SimpleWEBServer extends Thread
{
    ...
    public static void main(String args[])
    {
        try
        {
            // привинтить сокет на локалхост, порт 3180
            ServerSocket server = new ServerSocket(3180, 0,
    ...
    public void run()
    {
        try
        {
            ...
            myReqPath = path.substring(path.lastIndexOf('.') + 1); // получаем расширение

            //System.out.println(path.substring(path.lastIndexOf('.') + 1));

            System.out.println(myReqPath);
            ...
            System.out.println(myReqPath.equals("jpg"));

            if(myReqPath.equals("jpg"))mime = "image/jpeg";
    ...
    protected String getPath(String header)
    {
        ...
        //path = "./ublic" + File.separator; //*c edited
